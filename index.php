...
<link href='http://fonts.googleapis.com/css?family=Overlock:400,900'
	rel='stylesheet' type='text/css'>


<script type="text/javascript"
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAo3z4buaY-xjj9YXQexPl_DQLCv03XRFo&sensor=true"></script>
<script type="text/javascript"
	src="http://maps.googleapis.com/maps/api/js?libraries=drawing&sensor=true"></script>
...
<script type="text/javascript">
   ...
   google.maps.event.addListener(map, 'dragend', function() {
	...
	//_GET['https://www.googleapis.com/fusiontables/v1/tables/1md9UwiFfywVXX8iPH5x4srBHQ9XwXFA3LO3wEDAT'];
	var xmlHttp = null;
	xmlHttp = new XMLHttpRequest();
	xmlHttp.open( "GET","https://www.googleapis.com/fusiontables/v1/query?sql=SELECT SLA_MAIN FROM 1md9UwiFfywVXX8iPH5x4srBHQ9XwXFA3LO3wEDAT" , false );
	xmlHttp.send( null );
...
<body onload="">
	...
	<div id="header">
		<div class="logo-main">
			<a href="#"><img src="images/logo2.png" alt="Census Matchmaker"></a>
		</div>
	</div>
	<div id="map"></div>
	<div class="search-box">
			...
			<form action="setSession.php" method="post">
					...
					<div class="wrapper-demo">
						<div id="dd" class="wrapper-dropdown-1" tabindex="1">
							...
							<ul class="dropdown" tabindex="1">
								...
								<li id="male"><a value="Males_Total_Percentage"><i
										<?php echo ($gender == "Males_Total_Percentage" ? "selected" : "") ;?>></i>Male</a></li>
								<li id="female"><a value="Females_Total_Percentage"><i
										<?php echo ($gender == "Females_Total_Percentage" ? "selected" : "") ;?>></i>Female</a></li>
							</ul>
						</div>
						​
					</div>
					...
					<div class="wrapper-demo1">
						<div id="dd3" class="wrapper-dropdown-Age" tabindex="1">
							...
							<ul class="dropdownAge" tabindex="1">
								<li id="age15"><a value="Persons_Percentage_Age_15_24_years"><i
										<?php echo ($ageRange == "Persons_Percentage_Age_15_24_years" ? "selected" : "") ;?>></i>18-24
										years</a></li>
								<li id="age25"><a value="Persons_Percentage_Age_25_44_years"><i
										<?php echo ($ageRange == "Persons_Percentage_Age_25_44_years" ? "selected" : "") ;?>></i>25-44
										years</a></li>
								<li id="age45"><a value="Persons_Percentage_Age_45_54_years"><i
										<?php echo ($ageRange == "Persons_Percentage_Age_45_54_years" ? "selected" : "") ;?>></i>45-54
										years</a></li>
								<li id="age55"><a value="Persons_Percentage_Age_55_64_years"><i
										<?php echo ($ageRange == "Persons_Percentage_Age_55_64_years" ? "selected" : "") ;?>></i>55-64
										years</a></li>
							</ul>
						</div>
						​
					...
					<div class="wrapper-demoEdu">
						<div id="dd4" class="wrapper-dropdown-Edu" tabindex="1">
							...
							<ul class="dropdownEdu" tabindex="1">
								...
								<li id="yes"><a
									value="Highest_year_of_school_completed_Did_not_go_to_school"><i
										<?php echo ($education == "Highest_year_of_school_completed_Did_not_go_to_school" ? "selected" : "") ;?>></i>Yes</a></li>
								<li id="no"><a value="no"><i
										<?php echo ($education == "no" ? "selected" : "") ;?>></i>No</a></li>
							</ul>
						</div>
						​
					</div>
					...
					<div class="wrapper-demoLang">
						...
						<div id="ddLang" class="wrapper-dropdown-Lang" tabindex="1">
							...
							<ul class="dropdownLanguage" tabindex="1">
								<li id="langy"><a value="Language_spoken_at_home_English_only"><i
										<?php echo ($language == "Language_spoken_at_home_English_only" ? "selected" : "") ;?>></i>English</a></li>
								<li id="langn"><a value="Language_spoken_at_home_Other_Language"><i
										<?php echo ($language == "Language_spoken_at_home_Other_Language" ? "selected" : "") ;?>></i>Other</a></li>
							</ul>
						</div>
						​
					</div>
					...
					<div class="wrapper-Reli">
						...
						<div id="ddReli" class="wrapper-dropdown-Reli" tabindex="1">
							...
							<ul class="dropdownReli">
								<li id="Buddhism1"><a value="Buddhism"><i
										<?php echo ($religion == "Buddhism" ? "selected" : "") ;?>></i>Buddhism</a></li>
								<li id="Christianity1"><a value="Christianity"><i
										<?php echo ($religion == "Christianity" ? "selected" : "") ;?>></i>Christianity</a></li>
								<li id="Hinduism1"><a value="Hinduism"><i
										<?php echo ($religion == "Hinduism" ?  "selected" : "") ;?>></i>Hinduism</a></li>
								<li id="Islam1"><a value="Islam"><i
										<?php echo ($religion == "Islam" ?  "selected" : "") ;?>></i>Islam</a></li>
								<li id="Judaism1"><a value="Judaism"><i
										<?php echo ($religion == "Judaism"  ? "selected" : "") ;?>></i>Judaism</a></li>
								<li id="Other1"><a value="Other_Religions_Total"><i
										<?php echo ($religion == "Other_Religions_Total" ? "selected" : "") ;?>></i>Others</a></li>
								<li id="Free_Thinker1"><a value="No_Religion"><i
										<?php echo ($religion == "No_Religion" ? "selected" : "") ;?>></i>Free
										Thinker</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="wrapper-Salary">
						...
						<div id="ddSalary" class="wrapper-dropdown-Salary" tabindex="1">
							...
							<ul class="dropdownSalary">
								<li id="salary1"><a value="Negative_Nil_income_Total_Percentage"><i
										<?php echo ($salary == "Negative_Nil_income_Total_Percentage" ? "selected" : "") ;?>></i>1</a></li>
								<li id="salary2"><a value="Total_One_Two_Hundred"><i
										<?php echo ($salary == "Total_One_Two_Hundred" ? "selected" : "") ;?>></i>2</a></li>
								<li id="salary3"><a value="Total_Two_Three_Hundred"><i
										<?php echo ($salary == "Total_Two_Three_Hundred" ?  "selected" : "") ;?>></i>3</a></li>
								<li id="salary4"><a value="Total_Three_Four_Hundred"><i
										<?php echo ($salary == "Total_Three_Four_Hundred" ?  "selected" : "") ;?>></i>4</a></li>
								<li id="salary5"><a value="Total_Four_Six_Hundred"><i
										<?php echo ($salary == "Total_Four_Six_Hundred"  ? "selected" : "") ;?>></i>5</a></li>
								<li id="salary6"><a value="Total_Six_Eight_Hundred"><i
										<?php echo ($salary == "Total_Six_Eight_Hundred" ? "selected" : "") ;?>></i>6</a></li>
								<li id="salary7"><a value="Total_Eight_Thousand"><i
										<?php echo ($salary == "Total_Eight_Thousand" ? "selected" : "") ;?>></i>7</a></li>
								<li id="salary8"><a value="Total_Thousand_Twelve_Thousand"><i
										<?php echo ($salary == "Total_Thousand_Twelve_Thousand" ? "selected" : "") ;?>></i>8</a></li>
								<li id="salary9"><a value="Total_Twelve_Fifteen_Thousand"><i
										<?php echo ($salary == "Total_Twelve_Fifteen_Thousand" ? "selected" : "") ;?>></i>9</a></li>
								<li id="salary10"><a value="Total_Fifteen_Two_Thousand"><i
										<?php echo ($salary == "Total_Fifteen_Two_Thousand" ?  "selected" : "") ;?>></i>10</li>
								<li id="salary11"><a value="Total_Two_Thousand"><i
										<?php echo ($salary == "Total_Two_Thousand" ?  "selected" : "") ;?>></i>11</a></li>
								<li id="salary12"><a
									value="Personal_income_not_stated_Total_Percentage"><i
										<?php echo ($salary == "Personal_income_not_stated_Total_Percentage"  ? "selected" : "") ;?>></i>12</a></li>
				...
				<section class="main">
					...
					<div class="wrapper-Employment">
						<div id="ddEmployment" class="wrapper-dropdown-Employment"
							tabindex="1">
							<span>Employment</span>
							<!--Lets users select the choices -->
							<ul class="dropdownEmployment" tabindex="1">
								<li id="Employment1"><a
									value="Employed_worked_Full_time_Total_Percentage"><i
										<?php echo ($employment == "Employed_worked_Full_time_Total_Percentage" ? "selected" : "") ;?>></i>Full-Time</a></li>
								<li id="Employment2"><a
									value="Employed_worked_Part_time_Total_Percentage"><i
										<?php echo ($employment == "Employed_worked_Part_time_Total_Percentage" ? "selected" : "") ;?>></i>Part-Time</a></li>
							</ul>
						</div>
						​
					</div>
				...
				<section class="main">
					...
					<div class="wrapper-Children">
						<div id="ddChildren" class="wrapper-dropdown-Children"
							tabindex="1">
							<span>Children</span>
							<!--Lets users select the choices -->
							<ul class="dropdownChildren">
								<li id="child1"><a
									value="Total_Number_of_children_ever_born_No_children"><i
										<?php echo ($children == "Total_Number_of_children_ever_born_No_children" ? "selected" : "") ;?>></i>0</a></li>
								<li id="child2"><a
									value="Total_Number_of_children_ever_born_One_child"><i
										<?php echo ($children == "Total_Number_of_children_ever_born_One_child" ? "selected" : "") ;?>></i>1</a></li>
								<li id="child3"><a
									value="Total_Number_of_children_ever_born_Two_children"><i
										<?php echo ($children == "Total_Number_of_children_ever_born_Two_children" ?  "selected" : "") ;?>></i>2</a></li>
								<li id="child4"><a
									value="Total_Number_of_children_ever_born_Three_children"><i
										<?php echo ($children == "Total_Number_of_children_ever_born_Three_children" ?  "selected" : "") ;?>></i>3</a></li>
								<li id="child5"><a
									value="Total_Number_of_children_ever_born_Four_children"><i
										<?php echo ($children == "Total_Number_of_children_ever_born_Four_children"  ? "selected" : "") ;?>></i>4</a></li>
								<li id="child6"><a
									value="Total_Number_of_children_ever_born_Five_children"><i
										<?php echo ($children == "Total_Number_of_children_ever_born_Five_children" ? "selected" : "") ;?>></i>5</a></li>
								<li id="child7"><a
									value="Total_Number_of_children_ever_born_Six_or_more_children"><i
										<?php echo ($children == "Total_Number_of_children_ever_born_Six_or_more_children" ? "selected" : "") ;?>></i>6</a></li>
							</ul>
						</div>
					</div>
				</section>
					...
					<div class="wrapper-demo2">
						<div id="dd2" class="wrapper-dropdown-Nat" tabindex="1">
							...
							<ul class="dropdownNationality">
								<li id="australia"><a value="Persons_Australia_Percentage"><i
										<?php echo ($nationality == "Persons_Australia_Percentage" ? "selected" : "") ;?>></i>Australian</a></li>
								<li id="china"><a
									value="Persons_China_excludes_SARs_and_Taiwan_Percentage"><i
										<?php echo ($nationality == "Persons_China_excludes_SARs_and_Taiwan_Percentage" ? "selected" : "") ;?>></i>China</a></li>
								<li id="croatia"><a value="Persons_Croatia_Percentage"><i
										<?php echo ($nationality == "Persons_Croatia_Percentage" ? "selected" : "") ;?>></i>Croatian</a></li>
								<li id="england"><a value="Persons_England_Percentage"><i
										<?php echo ($nationality == "Persons_England_Percentage" ? "selected" : "") ;?>></i>English</a></li>
								<li id="fiji"><a value="Persons_Fiji_Percentage"><i
										<?php echo ($nationality == "Persons_Fiji_Percentage" ? "selected" : "") ;?>></i>Fijian</a></li>
								<li id="germany"><a value="Persons_Germany_Percentage"><i
										<?php echo ($nationality == "Persons_Germany_Percentage" ? "selected" : "") ;?>></i>German</a></li>
								<li id="greece"><a value="Persons_Greece_Percentage"><i
										<?php echo ($nationality == "Persons_Greece_Percentage" ? "selected" : "") ;?>></i>Greek</a></li>
								<li id="hk"><a value="Persons_Hong_Kong_SAR_of_China_Percentage"><i
										<?php echo ($nationality == "Persons_Hong_Kong_SAR_of_China_Percentage" ? "selected" : "") ;?>></i>Hong
										Kongese</a></li>
								<li id="india"><a value="Persons_India_Percentage"><i
										<?php echo ($nationality == "Persons_India_Percentage" ? "selected" : "") ;?>></i>Indian</a></li>
								<li id="indo"><a value="Persons_Indonesia_Percentage"><i
										<?php echo ($nationality == "Persons_Indonesia_Percentage" ? "selected" : "") ;?>></i>Indonesian</a></li>
								<li id="iraq"><a value="Persons_Iraq_Percentage"><i
										<?php echo ($nationality == "Persons_Iraq_Percentage" ? "selected" : "") ;?>></i>Iraqi</a></li>
								<li id="ireland"><a value="Persons_Ireland_Percentage"><i
										<?php echo ($nationality == "Persons_Ireland_Percentage" ? "selected" : "") ;?>></i>Irish</a></li>
								<li id="italy"><a value="Persons_Italy_Percentage"><i
										<?php echo ($nationality == "Persons_Italy_Percentage" ? "selected" : "") ;?>></i>Italian</a></li>
								<li id="korea"><a
									value="Persons_Korea_Republic_of_South_Percentage"><i
										<?php echo ($nationality == "Persons_Korea_Republic_of_South_Percentage" ? "selected" : "") ;?>></i>Korean</a></li>
								<li id="lebanon"><a value="Persons_Lebanon_Percentage"><i
										<?php echo ($nationality == "Persons_Lebanon_Percentage" ? "selected" : "") ;?>></i>Labanese</a></li>
								<li id="malaysia"><a value="Persons_Malaysia_Percentage"><i
										<?php echo ($nationality == "Persons_Malaysia_Percentage" ? "selected" : "") ;?>></i>Malaysian</a></li>
								<li id="netherlands"><a value="Persons_Netherlands_Percentage"><i
										<?php echo ($nationality == "Persons_Netherlands_Percentage" ? "selected" : "") ;?>></i>Dutch</a></li>
								<li id="nz"><a value="Persons_New_Zealand_Percentage"><i
										<?php echo ($nationality == "Persons_New_Zealand_Percentage" ? "selected" : "") ;?>></i>New
										Zealander</a></li>
								<li id="philippines"><a value="Persons_Philippines_Percentage"><i
										<?php echo ($nationality == "Persons_Philippines_Percentage" ? "selected" : "") ;?>></i>Philippino</a></li>
								<li id="scotland"><a value="Persons_Scotland_Percentage"><i
										<?php echo ($nationality == "Persons_Scotland_Percentage" ? "selected" : "") ;?>></i>Scottish</a></li>
								<li id="singapore"><a value="Persons_Singapore_Percentage"><i
										<?php echo ($nationality == "Persons_Singapore_Percentage" ? "selected" : "") ;?>></i>Singaporean</a></li>
								<li id="africa"><a value="Persons_South_Africa_Percentage"><i
										<?php echo ($nationality == "Persons_South_Africa_Percentage" ? "selected" : "") ;?>></i>South
										African</a></li>
								<li id="srilanka"><a value="Persons_Sri_Lanka_Percentage"><i
										<?php echo ($nationality == "Persons_Sri_Lanka_Percentage" ? "selected" : "") ;?>></i>Sri
										Lankan</a></li>
								<li id="usa"><a
									value="Persons_United_States_of_America_Percentage"><i
										<?php echo ($nationality == "Persons_United_States_of_America_Percentage" ? "selected" : "") ;?>></i>American</a></li>
								<li id="vietnam"><a value="Persons_Vietnam_Percentage"><i
										<?php echo ($nationality == "Persons_Vietnam_Percentage" ? "selected" : "") ;?>></i>Vietnamese</a></li>
				...
				<input type="hidden" id="gender" name="gender" value=""></input> <input
					type="hidden" name="ageRange" id="ageRange" value=""></input> <input
					type="hidden" id="education" name="education" value=""></input> <input
					type="hidden" id="language" name="language" value=""></input> <input
					type="hidden" id="religion" name="religion" value=""></input> <input
					type="hidden" id="nationality" name="nationality" value=""></input>
				<input type="hidden" id="salary" name="salary" value=""></input> <input
					type="hidden" id="employment" name="employment" value=""></input> <input
					type="hidden" id="children" name="children" value=""></input>
				<!--Submit Button-->
				<input id="joni" type="submit" value="Find Your Match" name="submit"
					onsubmit="getIndex()">
			</form>
		...
		<div class="show-hide">
			<p id="magic">
				<a href="#"><img src="images/logo3.png" alt="Census Matchmaker">
