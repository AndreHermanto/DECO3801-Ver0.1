   ...
   google.maps.event.addListener(map, 'dragend', function() {
	...
	// Create Google Fusion Table layer
	   var layer = new google.maps.FusionTablesLayer({
		 ...
		 //Design Query
			...
			from: apiKey
			   ...
			   where: gender + " > 0.30 AND " + age + " > 0.06 AND " + nationality + " > 0.003 AND " + education + " < 0.0015 AND " + language + " > 0.05 AND " + religion + " > 0.01  AND " + salary + " > 0.01 AND " + children + " > 0.01 AND " + employment + " > 0.01",
			   polygonOptions: {
				  fillColor: "#e9c0b9"
			   }
			},{
				  where: gender + " > 0.35 AND " + age + "  > 0.12 AND " + nationality + " > 0.0227 AND " +education + " < 0.0095 AND " + language + " > 0.1 AND " + religion + " > 0.05 AND " + salary + " > 0.05 AND " + children + " > 0.05 AND " + employment + " > 0.05",
			    polygonOptions: {
					  fillColor: "#EB13DD"
				   }
				},
				{
			   where: gender + " > 0.40 AND " + age + "  > 0.2 AND " + nationality + " > 0.0421 AND " +education + " < 0.0075 AND " + language + " > 0.25 AND " + religion + " > 0.14 AND " + salary + " > 0.15 AND " + children + " > 0.1 AND " + employment + " > 0.1",
			  polygonOptions: {
				  fillColor: "#13EAE6"
			   }
			}
	   ...
	   //No Match Found Pop Up
		...
		var query2 = "SELECT * FROM " + '1md9UwiFfywVXX8iPH5x4srBHQ9XwXFA3LO3wEDAT' + " WHERE " + gender + " > 0.30 AND " + age + " > 0.06 AND " + nationality + " > 0.003 AND " + education + " < 0.0015 AND " + language + " > 0.05 AND " + religion + " > 0.01  AND " + salary + " > 0.01 AND " + children + " > 0.01 AND " + employment + " > 0.01";		
				...
				<div class="wrapper-Salary">
					...
					<div id="ddSalary" class="wrapper-dropdown-Salary" tabindex="1">
						...
						<ul class="dropdownSalary">
							<li id="salary1"><a value="Negative_Nil_income_Total_Percentage"><i <?php echo ($salary == "Negative_Nil_income_Total_Percentage" ? "selected" : "") ;?> ></i>No Income</a></li>
							<li id="salary2"><a value="Total_One_Two_Hundred"><i <?php echo ($salary == "Total_One_Two_Hundred" ? "selected" : "") ;?> ></i>1 - 199 Weekly</a></li>
							<li id="salary3"><a value="Total_Two_Three_Hundred"><i <?php echo ($salary == "Total_Two_Three_Hundred" ?  "selected" : "") ;?> ></i>200 - 299 Weekly</a></li>
							<li id="salary4"><a value="Total_Three_Four_Hundred"><i <?php echo ($salary == "Total_Three_Four_Hundred" ?  "selected" : "") ;?> ></i>300 - 399 Weekly</a></li>
							<li id="salary5"><a value="Total_Four_Six_Hundred"><i <?php echo ($salary == "Total_Four_Six_Hundred"  ? "selected" : "") ;?> ></i>400 - 599 Weekly</a></li>
							<li id="salary6"><a value="Total_Six_Eight_Hundred"><i <?php echo ($salary == "Total_Six_Eight_Hundred" ? "selected" : "") ;?> ></i>600 - 799 Weekly</a></li>
							<li id="salary7"><a value="Total_Eight_Thousand"><i <?php echo ($salary == "Total_Eight_Thousand" ? "selected" : "") ;?> ></i>800 - 899 Weekly</a></li>
							<li id="salary8"><a value="Total_Thousand_Twelve_Thousand"><i <?php echo ($salary == "Total_Thousand_Twelve_Thousand" ? "selected" : "") ;?> ></i>1000 - 1249 Weekly</a></li>
							<li id="salary9"><a value="Total_Twelve_Fifteen_Thousand"><i <?php echo ($salary == "Total_Twelve_Fifteen_Thousand" ? "selected" : "") ;?> ></i>1250 - 1499 Weekly</a></li>
							...
							<li id="salary11"><a value="Total_Two_Thousand"><i <?php echo ($salary == "Total_Two_Thousand" ?  "selected" : "") ;?> ></i>More than 2000</a></li>
							<li id="salary12"><a value="Personal_income_not_stated_Total_Percentage"><i <?php echo ($salary == "Personal_income_not_stated_Total_Percentage"  ? "selected" : "") ;?> ></i>Undisclosed</a></li>
